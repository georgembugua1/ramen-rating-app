...
const ramenData = {
    'gyukotsu': { rating: '7/10', comment: 'Sweet beef broth, very satisfying' },
    'kojiro': { rating: '5/10', comment: 'Salty and flavorful' },
    'naruto': { rating: '10/10', comment: 'My best' },
    'nirvana': { rating: '9/10', comment: 'Unique taste' },
    'shoyu': { rating: '7/10', comment: 'Classic soy sauce' }
};
